 ...
 * <pre>{@code
 *  allprojects {
 *      task printBuildDependenciesPath{
 ...
 *
 */
class PrintBuildDependenciesPathTask extends AbsHelpTask {

    static void apply(Project project){
        project.allprojects {
            it.task('printBuildDependenciesPath', type: PrintBuildDependenciesPathTask)
        }
    }

    @TaskAction
    void run() {
        project.turquoise.printBuildDependenciesPathFilter.each { filter ->
